...
@section('title-page', 'Final Project | Hapus Pertanyaan')
@section('title', 'Hapus Pertanyaan')
@section('breadcumb', 'Hapus Pertanyaan')
@section('hapus-pertanyaan')
<div class="row">
    <div class="col-md-12">
        <div class="mr-3 p-1">
            {{-- foreach disini --}}
            ...
            <div class="card float-left mr-4" style="width: 20rem;">
                <div class="card-body" style="height:195px;">
                    ...
                    <div class="d-inline">
                        <a href="{{url('/edit')}}/{{$value['id']}}" class="btn btn-danger btn-sm">Hapus Pertanyaan</a>
